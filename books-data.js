...
const BOOKS_DATA = [
  ...
  },
  {
    ...
    "description": "Jakub Procházka byl vyvolen jako muž, který bude tvořit jednočlennou posádku rakety vyslanou na nebezpečnou misi k Venuši. Osamělý v nesmírnosti kosmu pohlíží Jakub na řadu věcí jinak než dřív, až se v raketě jako jeho nepravděpodobný společník objeví (snad jen imaginární) mimozemský pavouk. Zatímco spolu vedou filosofické debaty o povaze lásky, života a smrti, ale také lahodné chuti špeku, vytvoří se mezi nimi silné emocionální pouto. Čtivý a napínavý příběh skýtá řadu překvapení a zvratů. A kdo se spolu s ním vydá na cestu do hlubin kosmonautovy duše, možná se ani nebude chtít vracet.",
    "year": "2017"
  },
  {
    "country": "zahraniční",
    "genre": "🚀 sci-fi",
    "topic": "👽 mimozemská civilizace",
    "author": "Marissa Meyer",
    "name": "Renegáti",
    "description": "Renegáti jsou syndikát lidí s neobyčejnými schopnostmi. Vynořili se z trosek zničené společnosti a zavedli znovu řád tam, kde dosud vládl chaos. Jako obhájci práva a spravedlnosti jsou pro všechny symbolem odvahy a naděje. Výjimkou jsou zločinci, které kdysi svrhli. Nova má důvod Renegáty nenávidět a touží po pomstě. Jenže na cestě za svým cílem potká Adriana, který je Renegát. Dosáhne Nova nakonec své pomsty?",
    "year": "2018"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    ...
    "description": "Knižní série s antiutopickými prvky. Skládá se z trilogie, která sleduje příběh Katniss Everdeenové. Odehrává se v dystopickém státě Panem, který se skládá z bohatého Kapitolu a 13 krajů. Každý rok jsou vylosovány dvě děti – chlapec a dívka – z 12 krajů, aby bojovaly na život a na smrt v aréně v televizní reality show Hunger Games, která může mít jen jednoho vítěze.",
    "year": "2010"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    ...
    "author": "J. R. R. Tolkien",
    "name": "Pán prstenů",
    "description": "Strhující trilogie o hrdinné cestě malého hobita Froda Pytlíka za záchranu dávné Středozemě a jejích rozmanitých obyvatel před věčnou tmou a zlým čarodějem Sarumanem je příběh, kde hlavní roli hraje kouzelný prsten. Prsten, který je lépe nemít, a přitom po něm všichni touží.",
    "year": "1954"
  },
  {
    "country": "zahraniční",
    ...
    "description": "Série románů, povídek a dalších děl odehrávající se ve smyšleném světě Zeměplocha, jež je místo ležící na hřbetě želvy, která cestuje vesmírem. Terry Pratchett v těchto dílech často parodizuje známé fantasy příběhy, například díla J. R. R. Tolkiena. Kdo se chce zasmát a pobavit satiricky laděnou prózou, jsou pro něj příběhy Zeměplochy to pravé.\nV sérii se objevuje několik postav, jež knihy propojují. Seznámit se tak můžete například s Mrakoplašem, Smrtěm, Městskou hlídkou, Toničkou Bolavou nebo čarodějkami.",
    "year": "od 1983"
  },
  {
    "country": "zahraniční",
    ...
    "description": "Série příběhů o hraničáři Willovi a jeho přátelích. Will vyrůstá v opatrovně pro nalezence na hradě Redmontu. Sní o tom, že se jednou stane rytířem, ale kvůli své drobné postavě se musí tohoto snu vzdát. Zklamaného Willa vezme do učení hraničář Halt, uznávaný dokonce i ostřílenými rytíři. A hraničářské řemeslo se nakonec Willovi zalíbí tak, že by ho neměnil za nic na světě.",
    "year": "od 2004"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    ...
    "description": "Alenka se pustí do pronásledování bílého králíka, který kolem ní proběhl. Spadne do králičí nory, která se ukáže být branou do podivného světa, ve kterém jsou přírodní zákony vystřídány neomezenou fantazií, překrásně zobrazenou nádhernými ilustracemi, které vykreslují veškeré kouzlo tohoto zázračného světa.",
    "year": "1865"
  },
  {
    "country": "zahraniční",
    ...
    "name": "Eragon",
    "description": "První díl trilogie Odkaz Dračích jezdců je příběh chudého farmářského chlapce, který najde v Dračích horách modrý kámen, z něhož se vyklube dračí mládě – Safira. Spolu se vydají na nebezpečnou cestu královstvím ovládaným králem, jehož zlo nezná mezí. Dokáže Eragon naplnit své předurčení a převzít břímě le gendárních Dračích jezdců? Osud království možná leží v jeho rukou.",
    "year": "2004"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    "country": "zahraniční",
    "genre": "🧙‍♂️ fantasy",
    "topic": "⌛ cestování časem",
    "author": "Marianne Curley",
    "name": "Strážci času - série",
    "description": "Trilogie Strážci času vypráví o skupině lidí chránících historii. Žádný z nich neví o svých spolubojovnících, jednotliví členové znají pouze Tribunál a možná jednoho či dva další druhy. Identita strážců je přísně tajná, takže se může snadno stát, že dva takoví jedinci žijí vedle sebe, aniž by o sobě věděli.",
    "year": "od 2006"
  },
  {
    "country": "čeští",
  ...
  },
  {
    ...
    "name": "Víla Vivivíla",
    "description": "Máte rádi pohádky? Punkové pohádky? Jestli nevíte, co to je, vydejte se v noci se zvědavou vílou Vivivílou, která trochu moc vyplazovala jazyk, vždycky měla svou hlavu a klidně nosila nevílácké kalhoty, z bažin do Břevnova.",
    "year": "2009"
  },
  {
    "country": "čeští",
  ...
  },
  {
    ...
    "topic": "🐾 zvířata",
    "author": "Karel Čapek",
    "name": "Dášeňka čili život štěněte",
    "description": "Jedna z nejoblíbenějších českých dětských knížek. Karel Čapek si pořídil do domu na Vinohradech nejprve airdala, pak drsnosrstého teriéra Iris, mámu Dášeňky. Tahle krásná knížka kromě Života štěněte obsahuje i kapitoly Jak se fotografuje štěně a Pohádky pro Dášeňku, O psích zvyc ích nebo třeba O lidech. Půvabné vyprávění i obrázky budou provázet vaše děti po celý život.",
    "year": "1933"
  },
  {
    "country": "čeští",
  ...
  },
  {
    ...
    "description": "Medailonky významných českých žen z různých oborů lidské činnosti nás seznamují s jejich životním příběhem a zároveň i přibližují dobu, ve které žily. Byly odvážné. Mnohdy předběhly dobu. Šly si za svým a někdy za odvahu zaplatily cenu nejvyšší. Ale svým příběhem inspirovaly tisíce a miliony dalších žen, které dnes díky nim mohou žít svobodně a podle svých představ. Strhující vyprávění o šedesáti výjimečných a leckdy zapomenutých hrdinkách z české kotliny od těch nejdávnějších dob až po současnost doprovází originální portréty od studentů, textové medailony Kateřiny Tučkové a historické vstupy Renáty Fučíkové, které ukazují, jak se žilo ženám v různých obdobích dějin.",
    "year": "2020"
  },
  {
    "country": "čeští",
    "genre": "📚 faktografická literatura",
    "topic": "📜 historie",
    "author": "Renáta Fučíková",
    "name": "Tomáš Garrigue Masaryk",
    "description": "Je to vůbec první kniha, která osobu T. G. Masaryka zpřístupní dětem a mládeži. Text knihy, který si psala sama ilustrátorka a byl odborně redigován, je živě propojen s ilustracemi, které mají blízko ke klasické ilustraci i ke komiksu. Rozevřená kniha svou pestrostí připomene dobové noviny. T. G. Masaryk a vznik Československa poprvé také pro děti.",
    "year": "2006"
  },
  {
    "country": "čeští",
    ...
    "description": "Přední česká ilustrátorka tu jedinečným způsobem představuje nelehkou životní pouť T. G. Masaryka a spolu s ním důležité období české historie. Citlivě ztvárňuje také příběh rodiny žijící ve stínu mimořádného otce, příběh vnímavé a obětavé manželky a matky Charlotty.V. neposlední řadě též příběh národa této země, který po staletích dosáhl samostatnosti a vyrovnal se nejvyspělejším národům světa.",
    "year": "2008"
  },
  {
    "country": "čeští",
    ...
    "name": "Karel IV.",
    "description": "Doba panování Karla IV. je právem považovaná za zlatý věk českých dějin. Jaký ale doopravdy byl český král a římský císař, co všechno vykonal? Odpověď vám dá kniha plná ilustrací stejně delikátních, jaké známe z iluminovaných rukopisů vrcholného středověku. Dozvíte se, že Karel IV. byl nejen stavitelem mostů, hradů a měst. Velkou část svého života prožil na cestách mezi významnými městy tehdejší Evropy, jako byla Paříž, Milano, Benátky, Avignon, Řím, Florencie, Cáchy, Norimberk. Byl diplomatem a urovnával spory mezi panovníky, ale zároveň byl i válečníkem. Pro české země získal nová území.\nVelký odkaz zanechal Karel IV. v oblasti vědění, literatury a zákona. Sepsal legendy o životě nejstarších Přemyslovců, podílel se na vzniku kronik, sestavil nový zákoník, uprostřed Evropy založil univerzitu. Pečoval o rozvoj obchodu, umění a řemesel.",
    "year": "2016"
  },
  {
    "country": "čeští",
    "genre": "📚 faktografická literatura",
    "topic": "📜 historie",
    "author": "Milada Motlová",
    "name": "Praha známá i neznámá",
    "description": "Praha známá i neznámá je knížka o pozoruhodných památkách, místech i událostech krásného města s tisíciletou pamětí. Vede čtenáře po stopách historie Pražského hradu, Hradčan a Malé Strany přes Vltavu s jejími ostrovy a mosty na Staré a Židovské Město, Novým Městem na Vyšehrad i k místům za hradbami: Kapitoly o významných památkách jsou zpestřeny známými i méně známými historkami a pověstmi, doplňují je zajímavosti o životě ve staré Praze, přehledy historických dat, patronů pražských kostelů, církevních řádů, panovníků a vysvětlivky. Je určena všem, kteří chtějí Prahu nejen vidět, ale také se o ní něco dozvědět.",
    "year": "2004"
  },
  {
    "country": "čeští",
  ...
  },
  {
    ...
    "name": "Cirkadiánní kód",
    "description": "Je to tak snadné: stačí udržovat skrytý rytmus těla, které střídavě zapíná a vypíná své funkce, aby kromě práce zvládlo i regeneraci – a naše zdraví se zase vrátí ke své dokonalosti. Kdyby ale byly tyto poznatky tak samozřejmé, objevy na poli cirkadiánních rytmů by byly v roce 2017 je n těžko vyznamenány udělením Novelovy ceny. Civilizační výdobytky nám totiž tyto evolučně nastavené procesy skryly. S Pandovou poutavou knihou držíte v rukou příležitost, jak seřídit hodiny svého těla a trvale dosáhnout fyzické a duševní pohody. Naučíte se ovládat intenzitu světla, načasovat správně své jídlo, vyladit pohybovou aktivitu a oddávat se hlubokému spánku. Během několika týdnů zjistíte, jak skvělé je žít ve zdravém těle plném energie.",
    "year": "2020"
  },
  {
    "country": "zahraniční",
    ...
    "name": "Proč spíme",
    "description": "Kolik hodin jste dnes v noci spali? Pokud méně než osm, pak asi stejně jako většina lidstva trpíte spánkovou deprivací. A přicházíte o to nejlepší. Lidé, kteří si dopřávají dostatek spánku, jsou zdravější, chytřejší, štíhlejší, atraktivnější a šťastnější. Příčinu své úna vy a zdravotních potíží hledejte v nedostatku kvalitního spánku a pak teprve jinde.\n\nKniha předního světového neurovědce Matthewa Walkera odkrývá nejnovější poznatky z výzkumu spánku a ukazuje, že evoluce nás touto bezbrannou a neproduktivní fází denního rytmu nevybavila náhodou. Díky převratnému rozvoji a dostupnosti zobrazovacích metod dokáže věda poprvé v historii zodpovědět, proč vůbec spíme, jak spánek prospívá našemu tělu a mozku a proč má neřešená dlouhodobá spánková deprivace tak ničivé následky pro naše zdraví.\n\nWalker fascinujícím způsobem objasňuje vliv spánku na logické rozhodování, učení a paměť, na seřizování našich emocí a imunitní systém, ale i metabolismus a chuť k jídlu. A přesvědčivě dokládá, že chronický nedostatek kvalitního spánku nás může nejen mnoha různými způsoby zabít, ale také ovlivnit rozhodování a chování celé společnosti.\n\nSeznamte se i vy s posledními vědeckými objevy, díky nimž pochopíte, jaký elixír zdraví, štěstí i moudrosti ve svých životech (a postelích) máme. V knize najdete i rady, jak odstranit různé špatné návyky a další překážky, které brání kvalitnímu spánku vás i vašich blízkých.",
    "year": "2018"
  },
  {
    "country": "zahraniční",
    ...
    "name": "Sissi - Soukromý život Alžběty; císařovny rakouské",
    "description": "Se sympatiemi a pochopením pojatá biografie manželky Františka Josefa I., jejíž život byl nerozlučně spjatý s historií a osudem dynastie.\n\nAutorka zachycuje osud ženy, poznamenaný rodinnou výchovou na dvoře bavorského vévody, aristokratickou tradicí, ale zejména diktaturou tchyně, arcivévodkyně Žofie a manželovou oddaností k matce, dvorskému ceremoniálu a službě říši.",
    "year": "1992"
  },
  {
    "country": "čeští",
    "genre": "🗺️ dobrodružná literatura",
    "topic": "⚔️ dobrodružství",
    "author": "František Novotný",
    "name": "Robinson Crusoe",
    "description": "Nové převyprávění nesmrtelného příběhu o světoznámém trosečníkovi klade důraz na vlastnosti, bez nichž se člověk, jenž chce přežít v nebezpečných podmínkách, nedokáže obejít. A to ani v dnešní době. Odvaha, vytrvalost a zejména zdravý rozum hlavnímu hrdinovi Robinovi rozhodně nechybí. Jinak by nedokázal přežít všechny strasti, které ho čekají?",
    "year": "2005"
  },
  {
    "country": "čeští",
  ...
  },
  {
    ...
    "name": "Prašina",
    "description": "Prašina je tajuplné místo, temný ostrov uprostřed zářící Prahy. Nikdo neví proč, ale na Prašině nefunguje elektřina. Lampy tu nesvítí, tramvaje nejezdí, rádio nehraje, mobil je bez signálu. A v téhle strašidelné čtvrti pátrá Jirka se svými kamarády Tondou a En po dávném tajemství, kte ré by mohlo změnit svět. Jejich dobrodružství je o to nebezpečnější, že při něm musejí čelit partě všeho schopných dospělých chlapů, kteří mají stejný cíl. Foglarovsky laděný a mimořádně napínavý příběh doplňují ilustrace, které čtenáře vezmou přímo do nitra Prašiny.",
    "year": "2018"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    ...
    "author": "Ladislav Zibura",
    "name": "40 dní pěšky do Jeruzaléma",
    "description": "Autor v létě 2014 hodil batoh na záda a vydal se na pouť do Jeruzaléma. Bez mapy a orientačního smyslu pěšky ušel 1 400 kilometrů napříč rozpálenou krajinou Turecka a Izraele, stanul pod Zdí nářků a prožil největší dobrodružství svého života. Těšit se můžete na vyprávění kavárenského povaleče, který vám svým laskavě nekorektním humorem dokáže, že poutník rozhodně nemusí být katolík, asketa ani nudný člověk.",
    "year": "2015"
  },
  {
    "country": "čeští",
    ...
    "topic": "🌎 cestování po světě",
    "author": "Ladislav Zibura",
    "name": "Už nikdy pěšky po Arménii a Gruzii",
    "description": "Ladislav Zibura se vydává do těch nejzapadlejších vesnic, aby mohl poslouchat příběhy místních a načerpat něco z jejich\nmoudrosti. Alkohol teče proudem a mladý dobrodruh důvěrně poznává kulturu plnou pohostinnosti, rozhodných slov a sovětské nostalgie. Své zážitky z kavkazského putování líčí s tradičním humorem a sebeironií, pro které ho čtenáři nenávidí a milují.",
    "year": "2017"
  },
  {
    "country": "čeští",
    ...
    "topic": "🌎 cestování po světě",
    "author": "Martin Úbl",
    "name": "Neuvěřitelné příhody z hor",
    "description": "Co se stane, když expedici vede gumové kuře? Jaké jsou typické sny na treku? Jak to dopadá, když chlapec vezme svoji přítelkyni na 14 dní mimo civilizaci? Ač se může na první pohled zdát, že se úsměvné a někdy až k smíchu přivádějící příběhy z této knihy odehrávají v čistě horsk ém prostředí, není tomu tak. Během čtení čtenář zjistí, že jsou to příběhy napsané životem a o životě každého z nás. A jako i v životě, tak i na horách zdoláváte vrcholy i pády, ale s partou kamarádů jde všechno líp.",
    "year": "2017"
  },
  {
    "country": "čeští",
    ...
    "topic": "🌎 cestování po světě",
    "author": "Martin Úbl",
    "name": "Lehce neuvěřitelné příhody z hor",
    "description": "Nová dávka neuvěřitelných příhod z hor, které mohou na horách potkat i vás. Jak přežít týdny v divočině bez jakékoliv pomoci? Proč netrhat medvědům borůvky? Jak vylézt na šestitisícovku, když se vám zrovna nechce? Hory! Bažiny! Brody! Jezera! Žádná cesta! Déšť a dinosauři! Kniha o tom, jak rozdýchat hory, sebe, své kamarády a navíc se přitom výborně bavit.\nJak přežít týdny v divočině bez jakékoliv pomoci? Proč netrhat medvědům borůvky? Jak vylézt na šestitisícovku, když se vám zrovna nechce? Čtěte, a dozvíte se.",
    "year": "2020"
  },
  {
    "country": "čeští",
    ...
    "topic": "🏰 cestování po Česku",
    "author": "Martin Úbl",
    "name": "Stezka Českem: Může jít každý",
    "description": "První oficiální přechod po hranicích republiky. Kniha je kombinací průvodce, cestopisů, faktografických informací, turistických tipů ohledně trasy a oficiálního přechodu po hranicích republiky, která tvoří tisícikilometrovou trasu po jižní hranici a tisícikilometrovou po hranici severní.Kniha obsahuje jednak informativní kapitoly, ve kterých jsou popsány jednotlivé etapy, rady, jak se připravit na cestu, na co si dát pozor nebo tipy na nejkrásnější místa, ale také motivační kapitoly psány lidmi, kteří se rozhodli na Stezku vypravit. Samostatná kapitola je věnována Trail Angels, lidem, kteří ve svém volném čase dobrovolně pomáhají poutníkům na Stezce. Dočtete se ale také, na jakých principech a zásadách je Stezka založena, o Klubu českých turistů nebo třeba o udržitelném turismu.",
    "year": "2022"
  },
  {
    "country": "čeští",
  ...
  },
  {
    ...
    "name": "3333 km k Jakubovi",
    "description": "Před prázdninami Mirek dostane od táty nečekanou a nevšední nabídku - dobrodružnou výpravu přes několik států, končící ve Španělsku. Je to cesta svatého Jakuba s cílem v Santiagu de Compostela. Musí se ovšem ujet 3333 km - na kole! Mirek výzvu přijme. Náročné a nepohodlné putování se nakonec pro bohémského otce i pubertálního syna stane zásadním zlomem v životě.",
    "year": "2014"
  },
  {
    "country": "čeští",
    ...
    "description": "Cestopis po evropských trailech, ale také putování životem holky, které hory, láska a bucket list změnily život. Nečekejte jen tu krásnou stránku, Lucie je ochotná se podělit i o ten opravdový život, někdy krutý a jindy nespravedlivý. Inspirujte se a vydejte se na delší přechod, než je ten od gauče k lednici, nebo od domu do práce. Zkuste si prožít tu volnost, kdy jste to jen vy, těžký batoh, skvělá nálada a hory. Ale pozor! Lůca varuje, že když vyjdete jednou, nebude to naposledy.",
    "year": "2021"
  },
  {
    "country": "čeští",
  ...
  },
  {
    ...
    "genre": "🌍 cestopis",
    "topic": "🌎 cestování po světě",
    "author": "Monika Benešová",
    "name": "Moje Pacifická hřebenovka",
    "description": "Na Pacifickou hřebenovku se ročně vydá několik tisíc lidí, ale dokončí ji jen desetina z nich. Monika patří mezi ně. A to byla ještě před nedávnem bledou pacientkou s vážnými zdravotními a psychickými problémy. Přesto se rozhodla změnit život a splnit si sen – projít pěšky celou Ameri ku. Postavila se nemoci, poušti, omrzlinám, medvědům i pumám, které potkávala, když putovala sama divočinou. Pacifická hřebenovka ji tvrdě zkoušela. Naučila ji ale nevzdávat se.",
    "year": "2022"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    ...
    "name": "Vzhůru - Pozoruhodná cesta k vrcholu Mount Everestu",
    "description": "Bear Grylls jako nejmladší Brit v dějinách popisuje výstup na nejvyšší horu světa Mount Everest.\nAutor mj. poutavě líčí dlouhé období pobytu v základním táboře pod Mount Everestem, kdy čekali na lepší počasí aby mohli podniknout další cesty do výškových táborů, a posléze na vrchol. Poutavým způsobem líčí atmosféru vysokohorského prostředí, popisuje překrásné přírodní scenérie, charakterizuje rázovité osobnosti svých přátel a dalších horolezců, stejně jako fyzické i psychické utrpení. Ve svých 23 letech se Bear Grylls stal nejmladším Britem, který vystoupil na vrchol této nejvyšší hory světa.",
    "year": "2011"
  },
  {
    "country": "zahraniční",
    ...
    "topic": "🌎 cestování po světě",
    "author": "Jon Krakauer",
    "name": "Útěk do divočiny",
    "description": "Ihned poté, co Christopher McCandless dostudoval vysokou školu, věnoval všechny své peníze na dobročinné účely, sbalil si věci a začal se toulat po Americe. Když v dubnu 1992 dorazil na Aljašku, opustil své auto, spálil hotovost, která mu ještě zbývala, a bez mapy a dalších pomůcek se vydal do divočiny – žít po vzoru Londona, Tolstého nebo Thoreaua. O čtyři měsíce později našli v rozbitém odstaveném autobuse jeho vychrtlé mrtvé tělo. Jeho příběh hluboce zaujal novináře, spisovatele, horolezce a dobrodruha Jona Krakauera, který mapuje celé McCandlessovo putování, dává slovo lidem, s nimiž se mladík setkal, cituje jeho deník, dopisy či podtrhaná místa v knihách. Hledá mladíkovy motivy i důvody jeho selhání. Útěk do divočiny není pouhou rekonstrukcí možných událostí. Je napínavým příběhem, který dokládá autorovo dokonalé vcítění – rozpravou o lidské touze po riziku, volnosti a čistém životě v souladu s přírodou.",
    "year": "1999"
  },
  {
    "country": "čeští",
  ...
  },
  {
    ...
    "author": "Petr Nikl",
    "name": "Záhádky",
    "description": "Komplexní umělecké dílo, které malé i větší čtenáře zavádí do světa hravé fantazie. Tentokrát jde Petr Nikl ještě o kousek dál – čtenář si bude moci sám skládat obrázky zvířat a fantaskních tvorů z jednotlivých rozstříhaných listů (hlavy, těla a nohou) a k tomu dotvářet texty.",
    "year": "2007"
  },
  {
    "country": "čeští",
    ...
    "description": "Čtyři správní kluci z Holešovic Čenda, Aleš, Mirek a Bořík spolu zažívají neuvěřitelně veselé i dobrodružné příhody. Často se taky potýkají s nepřízní rodičů a třídní učitelky. Na rozdíl od třídního šprta Bohouška, který je mazánkem dospělých..",
    "year": "od 1970"
  },
  {
    "country": "čeští",
    ...
    "author": "Vojtěch Steklač",
    "name": "Pekelná třída",
    "description": "Pekelná třída - to je parta, se kterou se seznámítei i ve třech knížkách boříkovských lapálií. Dozvíte se od ní, jak vnímají září, jak si celý školní rok zpestřují nejrůznějšími vylomeninami, co všechno je láká ve Stromovce, jak se potýkají se Zátoráky, jak si udělali mejdan, jak se vypořádávají se šplhounem Bohouškem, jak doma válčí s rodiči. Není divu, že jejich nebohá paní třídní učitelka, něžně přezdívaná Drábinka, se často chytá za hlavu a volá: \"Tahle třída, to je peklo!\"",
    "year": "1978"
  },
  {
    "country": "čeští",
    ...
    "name": "Bylo nás pět",
    "description": "Půvabná vyprávění o dobrodružstvích pěti nezbedných chlapců z malého českého městečka, psaná formou dětského deníku kupeckého synka Petra Bajzy.\nKlukovskýma očima viděný rok na maloměstě připomíná všechny sezónní dospělé i dětské zábavy, životní styl i hierarchii obyvatel ma lého města za první republiky.",
    "year": "1943"
  },
  {
    "country": "zahraniční",
    ...
    "name": "Mikulášovy patálie",
    "description": "Mikuláš je malý nezbedný kluk s partou kamarádů, kupou bláznivých nápadů a úžasným dětským pohledem na svět. „Když jsem přišel domů, maminka mi vynadala, že jsem přišel pozdě na večeři. Když jsou takoví, tak tedy bez milosti: Zítra uteču z domova. Tatínek s maminkou se budou hrozně trápit a já se vrátím až za spoustu let a budu strašlivě bohatý a budu mít auto a letadlo!\"",
    "year": "1964"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    ...
    "topic": "⚔️ dobrodružství",
    "author": "Jaroslav Foglar",
    "name": "Stínadelská trilogie",
    "description": "Souborné vydání komiksové Stínadelské trilogie obsahuje Záhadu hlavolamu, Stínadla se bouří a Tajemství Velkého Vonta. \nVydejte se s partou Rychlých šípů na pořádnou dávku dobrodružství.",
    "year": "2023"
  },
  {
    "country": "čeští",
    ...
    "author": "Jaroslav Foglar",
    "name": "Rychlé šípy",
    "description": "V temných Stínadlech se cosi dalo do pohybu! Klub Rychlých šípů – Mirek Dušín, Jarka Metelka, Jindra Hojer, Červenáček a Rychlonožka – u toho nesmí chybět! Když chlapci poznají příběh zámečnického učně Jana Tleskače, podniknou nebezpečnou výpravu na nepřátelské území, kde je ukryt kovový hlavolam ježek v kleci. Rychlé šípy to však nebudou mít jednoduché. Stínadlům totiž vládne drsná parta Vontů...",
    "year": "2019"
  },
  {
    "country": "čeští",
    ...
    "topic": "🏃 sport",
    "author": "Jan Novák",
    "name": "Zátopek... když nemůžeš, tak přidej!",
    "description": "„Je to hranice bolesti a utrpení, která dělí chlapce od mužů,“ říkal Emil Zátopek. Právě posouvání mezí možností vlastního těla z něj udělalo fenomenálního běžce a jednoho z nejslavnějších sportovců historie. Když na olympijských hrách v Londýně v roce 1948 vyhrál běh na deset kilometrů a na pětikilometrové trati skončil druhý, nepovažoval to za velký úspěch. Z následující olympiády v Helsinkách přivezl tři zlaté medaile a stal se legendou, ale připsal si i důležitější vítězství – postavil se proti režimu za svého svěřence Stanislava Jungwirtha a prosadil, aby vůbec mohl na olympiádu odcestovat.",
    "year": "2016"
  },
  {
    "country": "zahraniční",
    ...
    "description": "Mix Pána prstenů a animovaných filmů od Pixaru – tak by se dal popsat legendární fantasy epos Kůstek. Zavede vás do světa, který je plný prapodivných bytostí – věčně hladových krysáků, bojových včel, obřích rudých draků (s doutníkem) a agresivních babiček. Do světa krásného i nebezpečného. Příběh začíná úprkem tří podivných bytostí z rodného města, pokračuje závodem krav a končí bojem o osud světa s tajemným Pánem kobylek a jeho hordami. Je tu všechno, co má klasické fantasy mít (možná až na ten závod krav), jen ti hrdinové jsou na klasické fantasy tak trochu... zvláštní. Kůstek si rychle získal kultovní věhlas, veškerá možná ocenění a post jednoho z nejzásadnějších světových komiksů. Není divu, nabízí rozmáchlý příběh, ve kterém se mísí humor s emocemi, napětím a hororem a jedno plynule přechází v druhé. Příběh, který osloví absolutně každého. \n\n Toto je první díl z celé série.",
    "year": "2010"
  },
  {
    "country": "zahraniční",
    ...
    "description": "Série komixů o belgickém reportérovi Tintinovi, který společně se svým věrným psem zažívá dobrodružství a vyšetřuje různé záhady po celém světě. /n Humorně pojaté příběhy doplňují propracované kresby.",
    "year": "od 1930"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    ...
    "topic": "🔧 technika",
    "author": "Edward Ross",
    "name": "Paříme - Komiksová historie videoher",
    "description": "Od chvíle, kdy poprvé spustil bratrovo zaprášené atari, se komiksový kreslíř Edward Ross zbláznil do videoher. Po letech si začal klást otázky: Čím jsou hry tak výjimečné? Proč je hrajeme? A jak hry ovlivňují náš svět? V publikaci vhodné pro malé i velké zájemce nás provází časem od průkopnických technických vynálezů ze čtyřicátých let až po moderní éru blockbusterových hitů a skvostů nezávislé scény. Fanoušci a fanynky se mohou těšit, že na stránkách spatří legendární hry jako Minecraft, Super Mario, Doom, Last of Us, God of War, Legend of Zelda, Grand Theft Auto, Tomb Raider nebo Fallout. \n\nCo nás hry jako Dungeons & Dragons nebo Bioshock učí o svobodné vůli a osobní odpovědnosti? Jak herní designéři vytvářejí krajiny, v nichž se chceme ztratit? Proč a jak se ovladače stávají prodloužením našich těl? Jak se proměnilo zobrazení žen či ras ve videohrách? A ve které zemi způsobila obliba arkádových automatů nedostatek drobných?",
    "year": "2024"
  },
  {
    "country": "zahraniční",
    "genre": "💭 komiks",
    "topic": "⚔️ dobrodružství",
    "author": "Charles Dixon, Sean Deming",
    "name": "Hobit aneb Cesta tam a zase zpátky",
    "description": "Hobit je příběh Bilba Pytlíka, klidného a spokojeného hobita, kterému se celý život obrátí vzhůru nohama, když se připojí k čaroději Gandalfovi a třinácti trpaslíkům na výpravě za ukradeným pokladem. Je to cesta plná nebezpečí - a na konci musí Bilbo samojediný čelit strážci tohoto pokladu, nejobávanějšímu draku v celé Středozemi...",
    "year": "2007"
  },
  {
    "country": "zahraniční",
  ...
  },
  {
    ...
    "author": "Markus Zusak",
    "name": "Zlodějka knih",
    "description": "Příběh se odehrává v nacistickém Německu a líčí dospívání mladé dívky Liesel, která začíná nový život v pěstounské péči poté, co ji opustila matka. Příběh vypráví o Lieselině vztahu s pěstouny, s ostatními obyvateli města i s mladým židovským mužem, kterého se svou nově nalezenou rodinou ukrývá ve sklepě svého domu.",
    "year": "2005"
  },
  {
    "country": "zahraniční",
    ...
    "description": "Osud Christiane F. znají miliony čtenářů po celém světě. Vyrůstali s drásavou výpovědí třináctileté německé narkomanky o pekle závislosti na heroinu a prostituci. Kniha My děti ze stanice ZOO a stejnojmenný film z ní udělaly celebritu a změnily zásadně její život. Po pětatřiceti letec h se Christiane Felscherinow nechala přesvědčit novinářkou Sonjou Vukovic, aby vyprávěla, co bylo potom. Procházíme spolu s Christiane jejím bojem se závislostí na drogách, pobytem ve vězení, ale také setkáními s legendami amerického rocku a evropské literatury, šťastnými roky v Řecku a největším darem – narozením syna Phillipa.",
    "year": "2014"
  },
  {
    "country": "zahraniční",
    ...
    "name": "Upíří deníky",
    "description": "Tato série sleduje životy upírů a jejich interakce s lidmi v moderním světě. Hlavní postavy, jako je Elena Gilbert a Stefan Salvatore, se potýkají s láskou, zradou a nebezpečím, které přichází s jejich nadpřirozenými schopnostmi. Příběh je plný napětí, romantiky a dramatických zvratů. Čtenáři se ponoří do fascinujícího světa, kde se mísí realita s nadpřirozenem.",
    "year": "od 1991"
  },
  {
    "country": "zahraniční",
    ...
    "author": "Stephenie Meyer",
    "name": "Stmívání",
    "description": "\"Stmívání\" je fenoménem, který oslnil čtenáře po celém světě. Tato kultovní knižní série od Stephenie Meyerové nás vtáhne do světa naplněného romantikou, nadpřirozenem a nebezpečnými tajemstvími. První díl série nese název \"Stmívání\" a zavede nás do městečka Forks, kde se hlavní hrdinka Bella Swanová zamiluje do tajuplného Edwarda Cullena. /n Edward a jeho rodina však ukrývají temné tajemství – jsou upíři. Přestože se snaží Bella i Edward překonat své odlišné podstaty, jejich láska je neustále prověřována vnějšími hrozbami a vnitřními konflikty. Čtenáři se mohou těšit na napínavý milostný příběh, který zahrnuje nadpřirozené bytosti, nebezpečné střety a nepřekonatelné překážky.",
    "year": "od 2005"
  },
  {
    "country": "zahraniční",
    ...
    "topic": "🌱 dospívání",
    "author": "Grace Dent",
    "name": "Klukům vstup zakázán",
    "description": "Veronika a její dvě kamarádky se chtějí vydat na rockový festival, ale rodiče je nepustí, protože o ně mají strach. A tak si tři kamarádky na pozemk u školy uspořádají festival vlastní, s účastí školních kapel včetně skejťáka Jimiho, do kterého je Veronika zamilovaná. A možná se objeví i další hvězdy.",
    "year": "2003"
  },
  {
    "country": "zahraniční",
    ...
    "name": "Dívka s pomeranči",
    "description": "Hrdinou této knihy je Georg, kterému zemřel otec, když byl hodně malý. A teď se najednou najde jeho dopis adresovaný synovi. Napsal ho krátce před smrtí, protože věděl, že mu chtěl předat některé své myšlenky a poselství, kterým by tehdy malý Georg nerozuměl. Tento emočně nabitý příb ěh vypráví o nemoci a marném boji, ale také o naději.",
    "year": "2003"
  },
  {
    "country": "zahraniční",
    ...
    "name": "Kniha džunglí",
    "description": "Lidské mládě. Odchovanec vlků, mrštný jako had a rychlý jako panter. Stane se lovcem lovců. Krásný dobrodružný příběh Mauglího, chlapce který vyroste mezi zvířaty v divoké džungli, splyne s ní a stane se její součástí. Dojemný vztah mezi člověkem a zvířaty, zvláště vlky.",
    "year": "1968"
  },
  {
    "country": "zahraniční",
    ...
    "topic": "🐾 zvířata",
    "author": "Jack London",
    "name": "Volání divočiny",
    "description": "Známý a proslavený příběh severského psa Bucka. S obdivhodnou věrojatností zobrazuje autor všechny prožitky Buckova přizpůsobování se přechodu z pohodlí a slunečného blahobytu na panském sídle do drsné a mrazivé skutečnosti Severu, kde se z něho stává chytrý, smělý a bojovný hrdina.",
    "year": "1957"
  },
  {
    "country": "zahraniční",
    ...
    "author": "Jack London",
    "name": "Bílý tesák",
    "description": "Ve vyprávění o osudech samotářského míšence psa a vlka vyjádřil autor své nejcennější myšlenky – víru v sílu života, přesvědčení o tom, že štěstí je neoddělitelné od věrnosti, s jakou dokážeme sloužit dobrým cílům.",
    "year": "1995"
  },
  {
    "country": "zahraniční",
    ...
    "topic": "⚔️ dobrodružství",
    "author": "Mark Twain",
    "name": "Dobrodružství Toma Sawyera",
    "description": "S uličníkem Tomem a jeho kamarádem Huckem budou dnešní kluci znovu prožívat dobrodružný útěk z domova, pirátský život na pustím ostrově i hledání pokladu ve strašidelném domě. Stejně jako mnoho generací před nimi budou číst o tom, jak se oba kamarádi zastali neprávem obviněného Mouly Pottera a ohromili poklidné městečko odhalením skutečného vraha.",
    "year": "1976"
  },
  {
    "country": "zahraniční",
